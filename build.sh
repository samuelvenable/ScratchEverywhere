...
if [ -d "build" ]; then
	...
	if [ "$OS" = "Windows_NT" ]; then
		cmake .. -DCMAKE_BUILD_TYPE=Release -DSE_DEPS="source" -DSE_RENDERER="sdl3" -DSE_WINDOWING="sdl3" -DSE_AUDIO_ENGINE="sdl3" -DSE_CLOUDVARS=OFF -DSE_DOWNLOAD=OFF -DSE_USE_LIBRARY_BUILD=OFF && ninja;
		cmake .. -DCMAKE_BUILD_TYPE=Release -DSE_DEPS="source" -DSE_RENDERER="sdl3" -DSE_WINDOWING="sdl3" -DSE_AUDIO_ENGINE="sdl3" -DSE_CLOUDVARS=OFF -DSE_DOWNLOAD=OFF -DSE_USE_LIBRARY_BUILD=ON && ninja;
		...
		cmake .. -DCMAKE_BUILD_TYPE=Release -DSE_DEPS="source" -DSE_RENDERER="sdl3" -DSE_WINDOWING="sdl3" -DSE_AUDIO_ENGINE="sdl3" -DSE_CLOUDVARS=OFF -DSE_DOWNLOAD=OFF -DSE_USE_LIBRARY_BUILD=OFF && make;
		cmake .. -DCMAKE_BUILD_TYPE=Release -DSE_DEPS="source" -DSE_RENDERER="sdl3" -DSE_WINDOWING="sdl3" -DSE_AUDIO_ENGINE="sdl3" -DSE_CLOUDVARS=OFF -DSE_DOWNLOAD=OFF -DSE_USE_LIBRARY_BUILD=ON && make;
	fi;
