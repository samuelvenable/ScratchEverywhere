...
function(_recipe_libdlgmod_source)
	...
	elseif(CMAKE_SYSTEM_NAME MATCHES "^(Linux|FreeBSD|DragonFly|NetBSD|OpenBSD|SunOS)$" AND NOT ANDROID AND NOT WEBOS AND NOT LIBRETRO)
		if(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT ANDROID AND NOT WEBOS AND NOT LIBRETRO)
			...
			target_compile_definitions(libdlgmod PUBLIC PROCESS_GUIWINDOW_IMPL NULLIFY_STDERR USE_XDG_DESKTOP_PORTAL)
			target_link_libraries(libdlgmod PUBLIC PkgConfig::DBUS)
		else()
	...
	elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux" AND NOT ANDROID AND NOT WEBOS AND NOT LIBRETRO)
